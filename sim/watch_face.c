...
/* Watch-face-only: double-size icons over two rows - see main/lvgl_app.c's
 * build_status_bar_big() (kept in sync by hand, same as the rest of this
 * file's watch-face logic). */
