...
#define SX1262_PIN_CS    BOARD_LORA_CS
#define SX1262_PIN_RESET BOARD_LORA_RESET
#define SX1262_PIN_BUSY  BOARD_LORA_BUSY
#define SX1262_PIN_IRQ   BOARD_LORA_INTERRUPT
